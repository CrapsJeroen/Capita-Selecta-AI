 ...
 * @version 3.0
 */
public abstract class CustomEvolutionStatistics<
    ...
    implements Consumer<EvolutionResult<?, C>>
{
    ...
    private static final class Comp<
        C extends Comparable<? super C>
        >
        extends CustomEvolutionStatistics<C, MinMax<C>>
    {
        private Comp() {
            _fitness = MinMax.of();
        }
    ...
    private static final class Num<N extends Number & Comparable<? super N>>
        extends CustomEvolutionStatistics<N, DoubleMomentStatistics>
    {
        private Num() {
    ...
    CustomEvolutionStatistics<C, MinMax<C>> ofComparable() {
        return new Comp<>();
    }

    public static <N extends Number & Comparable<? super N>>
    CustomEvolutionStatistics<N, DoubleMomentStatistics> ofNumber() {
        return new Num<>();
    }
